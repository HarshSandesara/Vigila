...
final List<EntryFirstAid> dataFirstAid = <EntryFirstAid>[
  ...
  EntryFirstAid(
    ...
    <EntryFirstAid>[
      ...
      EntryFirstAid(
          '• For injected poisons (e.g. needle, insects) remove the object if you can do so without causing further harm.'),
    ],
  ),
  EntryFirstAid(
    'Shocks',
    <EntryFirstAid>[
      ...
      EntryFirstAid(
          '• Put on any personal protective equipment which may be necessary for the situation, such as latex gloves for protection from blood born pathogens.'),
